...
cc.Class({
    ...
    onEnable () {
        ...
        Events.on(Events.BEFORE_REBIRTH, self.close, self);
    },
    ...
    onDisable () {
        ...
        Events.off(Events.BEFORE_REBIRTH, self.close, self);
    },
    ...
    fullView(){
        ...
        this.lbGoldenTimes.string = "伤害加成：+"+PublicFunc.numToStr(hero.golden*50*GameData.addGoldenDpsTimes)+"%"
    },
