    ...
    statics:{
        ...
        initAncient(resumeCloud){
            ...
            this.otherAncients = [
                ...
                new AncientData().init(13,false,false,"如意金箍2s",0,"desc12"),
                ...
                new AncientData().init(17,false,false,"加闲置妖丹",0,"desc15"),
                new AncientData().init(18,false,false,"+5%Gold",0,"desc16"),
                new AncientData().init(19,false,false,"葫芦妖丹50%",0,"desc17"),
