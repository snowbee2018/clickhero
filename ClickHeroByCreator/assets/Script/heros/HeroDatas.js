    ...
    statics:{
        ...
        initAncient(resumeCloud){
            ...
            this.otherAncients = [
                ...
                new AncientData().init(2,false,false,"催泪铃",0,"增加远古boss几率"),
                new AncientData().init(3,false,false,"鬼手刀",0,"增加三头六臂持续时间"),
                new AncientData().init(4,false,false,"莫邪宝剑",0,"增加暴击伤害"),
                // new AncientData().init(5,false,false,"崆峒印",0,"削弱Boss"),
                new AncientData().init(6,false,false,"不须鞭",0,"毫毛变化2s"),
                new AncientData().init(7,false,false,"昊天塔",0,"增加Boss计时器"),
                new AncientData().init(8,false,false,"神农鼎",0,"英雄减费"),
                new AncientData().init(9,false,false,"伏羲琴",0,"葫芦概率"),
                new AncientData().init(10,false,false,"夺魂箫",0,"金币探测器2s"),
                new AncientData().init(11,false,false,"九曲珠",0,"非Boss十倍"),
                new AncientData().init(12,false,false,"盘古斧",0,"每级增加20%点击伤害"),
                new AncientData().init(13,false,false,"玄天伞",0,"如意金箍2s"),
                // new AncientData().init(14,false,false,"jugg剑圣",0,"轩辕剑"),
                new AncientData().init(15,false,false,"炼妖壶",0,"点金手2s"),
                // new AncientData().init(16,false,false,"Argaiv",0),
                new AncientData().init(17,false,false,"女蜗补天石",0,"加闲置妖丹"),
                new AncientData().init(18,false,false,"昆仑镜",0,"+5%金币获得"),
                new AncientData().init(19,false,false,"玄天伞",0,"葫芦妖丹50%"),
                // new AncientData().init(20,false,false,"Argaiv",0),
                // new AncientData().init(21,false,false,"Argaiv",0),
                new AncientData().init(22,false,false,"逐日弓",0,"30%点金手"),
                // new AncientData().init(23,false,false,"Argaiv",0),
                new AncientData().init(24,false,false,"东皇钟",0,"加闲置DPS伤害"),
                new AncientData().init(25,false,false,"干将",0,"增加暴击风暴持续时间"),
                new AncientData().init(26,false,false,"火浣布",0,"技能冷却哥"),
            ];
            if (resumeCloud) {
