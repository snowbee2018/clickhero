    ...
    statics:{
        ...
        initAncient(resumeCloud){
            ...
            this.otherAncients = [
                ...
                new AncientData().init(6,false,false,"不须鞭",0,"增加毫毛变化持续时间2秒"),
                ...
                new AncientData().init(15,false,false,"炼妖壶",0,"增加0.01%*DPS的点击伤害"),
                // new AncientData().init(16,false,false,"Argaiv",0),
                new AncientData().init(17,false,false,"女蜗补天石",0,"增加加闲置妖丹掉落"),
                new AncientData().init(18,false,false,"昆仑镜",0,"增加普通怪妖丹掉落"),
                new AncientData().init(19,false,false,"崆峒印",0,"增加葫芦怪妖丹掉落"),
                // new AncientData().init(20,false,false,"Argaiv",0),
                // new AncientData().init(21,false,false,"Argaiv",0),
                new AncientData().init(22,false,false,"逐日弓",0,"增加点石成金妖丹获得"),
                ...
                new AncientData().init(26,false,false,"火浣布",0,"减少技能冷时间"),
            ];
            if (resumeCloud) {
